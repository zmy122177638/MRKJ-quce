...
<form method="post" action="" id="listform">
    <div class="panel admin-panel">
        <div class="panel-head"><strong class="icon-reorder">章节列表</strong> </div>
        <div class="padding border-bottom">

            <div class="label">
                <label>书本名称：<?php echo ($_GET['bookname']); ?></label>
            </div>
        ...
        <table class="table table-hover text-center">
            <tr>
                ...
                <?php if(is_array($arr)): foreach($arr as $key=>$value): ?><tr>
                    ...
                    <td ><?php echo ($value['booksname']); ?></td>
                    <td ><img src="/book/upload/bookimage/<?php echo ($value['booksimage']); ?>" width="100" height="100" alt=""/> </td>
                    <td ><?php echo ($value['audio']); ?></td>
                    <td ><?php echo ($value['timel']); ?></td>
