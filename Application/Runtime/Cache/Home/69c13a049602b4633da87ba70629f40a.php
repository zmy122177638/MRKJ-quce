...
<header class="public_header_container">
    ...
    <div class="public_banner"><img src="/quce/Public/images/cstest/banner_zf.png" width="100%" alt=""></div>
    <div class="paypage_content">
        ...
        <div class="lock_test_box">
            ...
            <div class="lock_img_box">
                <img class="J_pay_event" src="/quce/Public/images/cstest/01_zf.png" width="100%" alt="">
                <img class="J_pay_event" src="/quce/Public/images/cstest/02_zf.png" width="100%" alt="">
                <img class="J_pay_event" src="/quce/Public/images/cstest/03_zf.png" width="100%" alt="">
                <img class="J_pay_event" src="/quce/Public/images/cstest/04_zf.png" width="100%" alt="">
                <img class="J_pay_event" src="/quce/Public/images/cstest/05_zf.png" width="100%" alt="">
            </div>
        </div>
    </div>
    <!-- 支付弹窗 -->
    ...
    <div class="back_popup_container">
        ...
        <div class="back_popup_wrap">
            ...
            <div class="back_popup_top">
                <img src="/quce/Public/images/cstest/zf_bj.png" class="back_popup_banner" alt="">
