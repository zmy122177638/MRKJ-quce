...
(function (wid, dcm) {
  ...
  function DateSelector(config) {
    ...
    this.beforeBack = config.beforeBack || new Function();
    this.success    = config.success || new Function();
    ...
    this.title_time = this.recentTime==""?this.getDateTitle(this,this.recent_time):this.getDateTitle(this,this.recentTime);
